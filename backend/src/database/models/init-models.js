...
function initModels(sequelize) {
	...
	applicants.belongsToMany(professions, {
		as: 'professions',
	...
	professions.belongsToMany(applicants, {
		as: 'applicants',
		through: 'applicants_professions',
	...
	applicants_professions.belongsTo(applicants, {
		as: 'applicant',
		foreignKey: 'applicant_id',
	});
	applicants.hasMany(applicants_professions, {
		as: 'applicants_professions',
		foreignKey: 'applicant_id',
	});
	applicants_professions.belongsTo(professions, {
		as: 'profession',
		foreignKey: 'profession_id',
	});
	professions.hasMany(applicants_professions, {
		as: 'applicants_professions',
		foreignKey: 'profession_id',
	});
